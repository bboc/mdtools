...
class MenuMacro(object):
    ...
    def render(cls, config, structure, *args, **kwargs):
        ...
        return '\n'.join(cls.render_parts(structure, [], 3, noob_menu=config.noob_menu))
